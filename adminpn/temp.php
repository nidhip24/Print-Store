            ...
            <div class="col s12 m2">                
                <div class="sidenavv">
                    <ul class="custab">
                        ...
                        <li class="full-widthx tab"><a>Logout</a></li>
                    </ul>
                </div>
            </div>
                                            ...
                                            <div class="collapsible-body">
                                                <div class="row nomargin">
                                                    ...
                                                    <div class="col s12 m6" style="margin-left: 10px">
                                                        <p style="font-weight:600;margin-bottom:2px">Product name</p>
                                                        <p class="blue-text" style="font-weight:bold;margin:0px">quantity:2</p>
                                                        <p style="margin-bottom:2px;margin:0px">Product category: asa</p>
                                                        <p style="margin-bottom:2px;margin:0px">Sub category:</p>
                                                    </div>
                                                </div>          
                                            </div>
                                <?php   }
