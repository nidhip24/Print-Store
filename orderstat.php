...
<html>
    <head>
        ...
        <title>Order - The Vagad Print Store</title>
    </head>
...
-->
        ...
        if( isset($_GET['status']) ){
            $stat = $_GET['status'];
            if( $stat == "conf" ){ ?>
                <div class="row container" style="height : 350px">
                    <div class="col s12 m5 offset-m3 center">
            ...
            <?php }elseif( $stat == "failed" ){ ?>
                <div class="row container" style="height : 350px">
                    <div class="col s12 m5 offset-m3 center">
                        <h3>Transaction failed or cancelled by the user!</h3>
                    </div>
                </div>
            <?php }
        }else{ ?>
            <div class="row container" style="height : 350px">
                <h3>NO! <br>Go back to Home Page!</h3>
            </div>
        <?php }
